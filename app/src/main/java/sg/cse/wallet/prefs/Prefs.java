...
public class Prefs {
    ...
    public void savePinCode(String pincode) {
        editor.putString(PrefKey.PIN_CODE, pincode).apply();
    }

    public String getPinCode() {
        return sharedPreferences.getString(PrefKey.PIN_CODE,"");
    }

    public void removePinCode() {
        editor.remove(PrefKey.PIN_CODE).apply();
    }
}
