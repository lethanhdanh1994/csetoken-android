...
public class CardStackViewRequestSendAdapter extends ArrayAdapter<WalletRes.Doc> {
    private String balancetext;

    public CardStackViewRequestSendAdapter(Context context, String balancetext) {
        super(context, 0);
    ...
    public View getView(int position, View contentView, ViewGroup parent) {
        ...
        if (contentView == null) {
            ...
            contentView = inflater.inflate(R.layout.item_cardstack_request_send, parent, false);
